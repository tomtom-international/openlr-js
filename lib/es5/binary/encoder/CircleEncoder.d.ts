...
export declare class CircleEncoder extends AbstractEncoder {
    encodeData(rawLocationReference: RawLocationReference, version: number): LocationReference;
    protected _generateBinaryCircleLocation(center: GeoCoordinates, r: number, version: number): Buffer;
}
