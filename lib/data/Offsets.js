...
class Offsets {
    static fromValues(pOff, nOff) {
        ...
        offsets._version = BinaryConstants_1.default.BINARY_VERSION_2;
    ...
    static fromRelativeValues(pOff, nOff) {
        ...
        offsets._pOffset = 0;
        offsets._nOffset = 0;
        offsets._version = BinaryConstants_1.default.BINARY_VERSION_3;
    ...
    getPositiveOffset(length) {
        if (this.hasPositiveOffset()) {
            if (this._version === BinaryConstants_1.default.BINARY_VERSION_2) {
                return this._pOffset;
            }
            else if (this._version === BinaryConstants_1.default.BINARY_VERSION_3) {
