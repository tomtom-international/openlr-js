...
export declare class PolygonEncoder extends AbstractEncoder {
    encodeData(rawLocationReference: RawLocationReference, version: number): LocationReference;
    protected _generateBinaryPolygonLocation(cornerPoints: Array<GeoCoordinates>, version: number): Buffer;
}
