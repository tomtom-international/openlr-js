...
var LineDecoder = function (_AbstractDecoder) {
    ...
    function LineDecoder() {
        ...
        return _possibleConstructorReturn(this, (LineDecoder.__proto__ || Object.getPrototypeOf(LineDecoder)).apply(this, arguments));
    }
    ...
    _createClass(LineDecoder, [{
        ...
        value: function decodeData(id, bitStreamInput, totalBytes, version, binaryData) {
            ...
            var nrIntermediates = Math.floor((totalBytes - _BinaryConstants2.default.MIN_BYTES_LINE_LOCATION) / _BinaryConstants2.default.LRP_SIZE);
