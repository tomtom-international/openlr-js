...
var _GeoCoordEncoder = require('./encoder/GeoCoordEncoder');

var _GeoCoordEncoder2 = _interopRequireDefault(_GeoCoordEncoder);
    ...
    encodeDataFromRLRAndVersion(rawLocationReference, version) {
        ...
        switch (locationType) {
            case _LocationType2.default.GEO_COORDINATES:
                encoder = new _GeoCoordEncoder2.default();
                break;
