...
class Header extends _BinaryInformation2.default {
    ...
    static fromBitStreamInput(bitStreamInput) {
        ...
        if (rfu !== _BinaryInformation2.default._RFU_VALUE) {
    ...
    put(bitStreamOutput) {
        bitStreamOutput.putBits(_BinaryInformation2.default._RFU_VALUE, Header._RFU_BITS);
