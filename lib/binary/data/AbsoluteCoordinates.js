...
var AbsoluteCoordinates = function (_AbstractCoordinate) {
    _inherits(AbsoluteCoordinates, _AbstractCoordinate);

    function AbsoluteCoordinates() {
        _classCallCheck(this, AbsoluteCoordinates);

        return _possibleConstructorReturn(this, (AbsoluteCoordinates.__proto__ || Object.getPrototypeOf(AbsoluteCoordinates)).apply(this, arguments));
    }

    _createClass(AbsoluteCoordinates, [{
        key: 'put',
