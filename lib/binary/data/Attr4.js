...
var Attr4 = function (_BinaryInformation) {
    ...
    _createClass(Attr4, [{
        ...
        key: 'equals',
        value: function equals(otherAttr4) {
            return this._pOffsetF == otherAttr4._pOffsetF && this._nOffsetF == otherAttr4._nOffsetF && this._bear == otherAttr4._bear;
        }
    }, {
        key: 'pOffsetF',
        get: function get() {
        ...
        value: function fromBitStreamInput(bitStreamInput) {
            var rfu = bitStreamInput.getBits(Attr4._NR_RFU);
