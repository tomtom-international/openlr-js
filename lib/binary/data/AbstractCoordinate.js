...
var AbstractCoordinate = function (_BinaryInformation) {
    _inherits(AbstractCoordinate, _BinaryInformation);

    function AbstractCoordinate() {
        _classCallCheck(this, AbstractCoordinate);

        return _possibleConstructorReturn(this, (AbstractCoordinate.__proto__ || Object.getPrototypeOf(AbstractCoordinate)).apply(this, arguments));
    }

    _createClass(AbstractCoordinate, [{
        key: '_read',
        value: function _read(bitStreamInput) {
            this._lon = bitStreamInput.getSignedBits(this._coordBits);
            this._lat = bitStreamInput.getSignedBits(this._coordBits);
        }
    }, {
        key: 'putCoordinates',
        value: function putCoordinates(bitStreamOutput) {
        ...
        key: 'fromBitCount',
        value: function fromBitCount(countBits) {
