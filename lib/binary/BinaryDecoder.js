...
var _GeoCoordDecoder = require('./decoder/GeoCoordDecoder');

var _GeoCoordDecoder2 = _interopRequireDefault(_GeoCoordDecoder);
        ...
        if (!isPointLocation && !isAreaLocation && hasAttributes) {
            ...
            if (!hasAttributes) {
                if (totalBytes === _BinaryConstants2.default.GEOCOORD_SIZE) {
                    decoder = new _GeoCoordDecoder2.default();
                } else {
