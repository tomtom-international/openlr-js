...
const POINT_LOCATION_TYPES = new Set([_LocationType2.default.GEO_COORDINATES, _LocationType2.default.POI_WITH_ACCESS_POINT, _LocationType2.default.POINT_ALONG_LINE]);

/** The Constant AREA_LOCATION_VERSION. */
const AREA_LOCATION_VERSION = 3;

/** The Constant AREA_LOCATION_TYPES. */
const AREA_LOCATION_TYPES = new Set([_LocationType2.default.CIRCLE, _LocationType2.default.GRID, _LocationType2.default.CLOSED_LINE, _LocationType2.default.RECTANGLE, _LocationType2.default.POLYGON]);
