...
var BitStreamAbstract = function () {
    function BitStreamAbstract() {
        _classCallCheck(this, BitStreamAbstract);
    ...
    _createClass(BitStreamAbstract, [{
        key: '_expandBuffer',
        ...
        value: function _expandBuffer(newLength) {
            ...
            if (newLength > this._totalBufferLengthBytes) {
                ...
                var newBuffer = _buffer.Buffer.alloc(newLength);
        ...
        key: '_createBuffer',
        value: function _createBuffer(length) {
            this._totalBufferLengthBytes = length;
            this._buffer = _buffer.Buffer.alloc(length);
        }
    }, {
        key: '_getData',
        value: function _getData() {
            var byteLength = this._currentBit >>> BitStreamAbstract._BIT_BYTE_SHIFT;
            var copyBuffer = _buffer.Buffer.alloc(byteLength);
