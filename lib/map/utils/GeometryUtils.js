...
class GeometryUtils {
    ...
    static latitudeLongitudeIntersectStraights(longitude1, latitude1, bear1, longitude2, latitude2, bear2) {
        ...
        if (bear1 === 0.0) {
            ...
            return GeoCoordinates_1.default.fromValues(x, y);
        }
        if (bear2 === 0.0) {
            if (bear1 === 0.0) {
                return null;
    ...
    static lineIntersection(gc1Start, gc1End, gc2Start, gc2End) {
        const line1 = Line_1.default.fromValues(gc1Start.getLongitudeDeg(), gc1Start.getLatitudeDeg(), gc1End.getLongitudeDeg(), gc1End.getLatitudeDeg());
        const line2 = Line_1.default.fromValues(gc2Start.getLongitudeDeg(), gc2Start.getLatitudeDeg(), gc2End.getLongitudeDeg(), gc2End.getLatitudeDeg());
    ...
    static latitudeLongitudePointAlongLine(longitudeA, latitudeA, longitudeB, latitudeB, offset) {
        ...
        return GeoCoordinates_1.default.fromValues(lon, lat);
    }
    ...
    static latitudeLongitudeScaleUpperRightCoordinate(lowerLeftLon, lowerLeftLat, upperRightLon, upperRightLat, xFactor, yFactor) {
        ...
        return GeoCoordinates_1.default.fromValues(newBottomRight.getLongitudeDeg(), newTopLeft.getLatitudeDeg());
    }
    ...
    static latitudeLongitudeDetermineCoordinateInDistance(lon, lat, angle, distanceKm) {
        ...
        return GeoCoordinates_1.default.fromValues(lon2, lat2);
    }
