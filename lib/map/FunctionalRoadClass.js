...
exports.getFRCValues = () => [FunctionalRoadClass.FRC_0, FunctionalRoadClass.FRC_1, FunctionalRoadClass.FRC_2, FunctionalRoadClass.FRC_3, FunctionalRoadClass.FRC_4, FunctionalRoadClass.FRC_5, FunctionalRoadClass.FRC_6, FunctionalRoadClass.FRC_7];
exports.getId = (frc) => frc;
exports.lower = (frc) => Math.min(frc + 1, FunctionalRoadClass.FRC_7);
exports.higher = (frc) => Math.max(frc - 1, FunctionalRoadClass.FRC_0);
exports.getHighestFrc = FunctionalRoadClass.FRC_0;
exports.getLowestFrc = FunctionalRoadClass.FRC_7;
exports.default = FunctionalRoadClass;
