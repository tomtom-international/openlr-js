...
Supports [Node.js](http://nodejs.org) (v18+), web browsers (via the [Buffer](https://www.npmjs.com/package/buffer) package), and TypeScript/bundler toolchains. TypeScript type definitions are bundled with the package.
