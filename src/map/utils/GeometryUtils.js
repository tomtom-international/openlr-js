...
export default class GeometryUtils {
    ...
    static  _METER_PER_KILOMETER = 1000.0;
    ...
    static  FULL_CIRCLE_DEGREE = 360;

    /** = DIVISIONS_PER_DEGREE / DIVISIONS_PER_RADIAN */
    static  _RAD_FACTOR = 0.017453292519943294;

    /** The equatorial radius in meters */
    static  _EQUATORIAL_RADIUS = 6378137; // meter

    /** The Constant INVERSE_FLATTENING. */
    static  _INVERSE_FLATTENING = 298.257223563;

    /** The Constant OBLATENESS. */
    static  _OBLATENESS = 1 / GeometryUtils._INVERSE_FLATTENING;
    ...
    static latitudeLongitudeIntersectStraights(longitude1, latitude1, bear1, longitude2, latitude2, bear2) {
        ...
        return new GeoCoordinates.fromValues(x, y);
    }

    static lineIntersection(gc1Start, gc1End, gc2Start, gc2End) {
        const line1 = new Line(gc1Start.getLongitudeDeg(), gc1Start.getLatitudeDeg(), gc1End.getLongitudeDeg(), gc1End.getLatitudeDeg());
        const line2 = new Line(gc2Start.getLongitudeDeg(), gc2Start.getLatitudeDeg(), gc2End.getLongitudeDeg(), gc2End.getLatitudeDeg());
