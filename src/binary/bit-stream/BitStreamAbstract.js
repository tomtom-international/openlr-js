...
export default class BitStreamAbstract {
    ...
    static BIT_BYTE_SHIFT = 3;

    /** number of bits in a byte */
    static BYTE_SIZE = 8;

    /** position of the highest bit in a byte (count starts at 0) */
    static HIGHEST_BIT = BitStreamAbstract.BYTE_SIZE - 1;

    /**
     * Bit mask to mask the lowest bits of a byte
     */
    static BITMASK = [0x00000000, 0x00000001, 0x00000003,
     ...
     */
    static COMPLEMENT_MASK = [0xffffffff, 0xfffffffe, 0xfffffffc,
     ...
     */
    static SIGNED_MASK = [0x00000000, 0x00000001, 0x00000002,
    ...
    static DEFAULT_BUFFER_LENGTH = 1024;

    /** maximum number of bits which can be read/put at a time */
    static MAX_BIT_SIZE = 32;

    /** The internal data buffer */
    _buffer;

    /** The buffer size in bytes */
    _totalBufferLengthBytes = BitStreamAbstract.DEFAULT_BUFFER_LENGTH;
