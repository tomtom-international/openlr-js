...
export default class BitStreamAbstract {
    ...
    static _BIT_BYTE_SHIFT = 3;

    /** Number of bits in a byte */
    static _BYTE_SIZE = 8;

    /** position of the highest bit in a byte (count starts at 0) */
    static _HIGHEST_BIT = BitStreamAbstract._BYTE_SIZE - 1;

    /**
     * Bit mask to mask the lowest bits of a byte
     */
    static _BITMASK = [0x00000000, 0x00000001, 0x00000003,
     ...
     */
    static _COMPLEMENT_MASK = [0xffffffff, 0xfffffffe, 0xfffffffc,
     ...
     */
    static _SIGNED_MASK = [0x00000000, 0x00000001, 0x00000002,
    ...
    static _DEFAULT_BUFFER_LENGTH = 1024;

    /** maximum number of bits which can be read/put at a time */
    static _MAX_BIT_SIZE = 32;
