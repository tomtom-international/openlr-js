...
export default class AbstractEncoder {
    ...
    _generateAttribute2(lrp) {
        return Attr2.fromValues(FunctionalRoadClass.getId(lrp.getLfrc()), this._calculateBearingInterval(lrp.getBearing()));
    }
    ...
    _generateAttribute1FromLRP(lrp) {
        return Attr1.fromValues(FunctionalRoadClass.getId(lrp.getFRC()), FormOfWay.getId(lrp.getFOW()), 0);
    }

    _generateAttribute1FromLRPAndSideOfRoad(lrp, sideOfRoad) {
        return Attr1.fromValues(FunctionalRoadClass.getId(lrp.getFRC()), FormOfWay.getId(lrp.getFOW()), SideOfRoad.getId(sideOfRoad));
    }

    _generateAttribute1FromLRPAndOrientation(lrp, orientation) {
        return Attr1.fromValues(FunctionalRoadClass.getId(lrp.getFRC()), FormOfWay.getId(lrp.getFOW()), Orientation.getId(orientation));
    }
    ...
    _generateAttribute5(lrp) {
        return Attr5.fromValues(FunctionalRoadClass.getId(lrp.getFRC()), FormOfWay.getId(lrp.getFOW()));
    }
